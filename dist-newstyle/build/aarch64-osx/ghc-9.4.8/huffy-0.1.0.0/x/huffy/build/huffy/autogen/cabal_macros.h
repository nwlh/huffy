...
/* package huffy-0.1.0.0 */
#ifndef VERSION_huffy
#define VERSION_huffy "0.1.0.0"
#endif /* VERSION_huffy */
#ifndef MIN_VERSION_huffy
#define MIN_VERSION_huffy(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_huffy */
...
#define CURRENT_COMPONENT_ID "huffy-0.1.0.0-inplace-huffy"
